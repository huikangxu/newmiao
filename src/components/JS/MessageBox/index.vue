...
<style>
	.messageBox{width: 200px; height: 120px; border: 1px #ccc solid; border-radius: 4px; background-color: white; box-shadow: 3px 3px 3px 3px #ccc; position: absolute; top: 50%; margin: -60px 0 0 100px;}
