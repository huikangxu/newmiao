	...
	<div class="search_body">
		<div class="search_input">
			<div class="search_input_wrapper">
				...
				<input type="text" v-model="message"> <!-- v-model做数据双向绑定，是什么意思，有什么用？ -->
			</div>					
		</div>
		<div class="search_result">
			...
			<ul>
				<!-- <li>
					...
					<div class="info">
						<p><span>无名之辈1</span><span>8.5</span></p>
						<p>A Cool Fish</p>
						<p>剧情,喜剧,犯罪</p>
						<p>2018-11-16</p>
					</div>
...
<script>
	export default {
		...
		watch : {
			message(newVal){ //newVal:关键词
				var that = this;
				this.cancelRequest();
				this.axios.get('/api/api/searchList?cityId=10&kw='+newVal,{
